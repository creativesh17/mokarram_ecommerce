                ...
                <table class="table table-hover table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'product'" :title="'product'" />
                            <table-th :sort="true" :tkey="'name'" :title="'Name'" />
                            <table-th :sort="true" :tkey="'question'" :title="'Question'" />
                            <!-- <table-th :sort="true" :tkey="'answer'" :title="'Answer'" /> -->
                            <table-th :sort="true" :tkey="'is_approved'" :title="'Approved'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <input @click="approve(item.id)" type="checkbox" v-if="item.is_approved" checked class="form-check-input">
