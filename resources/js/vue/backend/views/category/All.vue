                ...
                <table class="table table-hover table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'is_home_category'" :title="'Home Category'" />
                            <table-th :sort="true" :tkey="'is_nav_category'" :title="'Nav Category'" />
                            <table-th :sort="true" :tkey="'parent_id'" :title="'Parent'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <input @click="call_store(`fetch_${store_prefix}_add_to_home_cat`,item.id)" type="checkbox" v-if="item.is_home_category" checked class="form-check-input">
                                <input @click="call_store(`fetch_${store_prefix}_add_to_home_cat`,item.id)" type="checkbox" v-else class="form-check-input">
                            </td>
                            <td>
                                <input @click="call_store(`fetch_${store_prefix}_add_to_nav_cat`,item.id)" type="checkbox" v-if="item.is_nav_category" checked class="form-check-input">
                                <input @click="call_store(`fetch_${store_prefix}_add_to_nav_cat`,item.id)" type="checkbox" v-else class="form-check-input">
                            </td>
                            <td>
...
export default {
    ...
    methods: {
        ...mapActions([
            ...
            `fetch_${store_prefix}_add_to_home_cat`,
            `fetch_${store_prefix}_add_to_nav_cat`,
