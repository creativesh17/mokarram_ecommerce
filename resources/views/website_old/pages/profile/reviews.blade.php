                        ...
                        <div class="product-review-item">
                            <div class="product-review-top">
                                ...
                                <div class="product-review-content">
                                    <h4 class="product-review-name">{{ $item->user->first_name . " " .
                            ...
                            <button type="button" wire:click="removeReview({{ $item->id }})" class="review-reply"
                                data-bs-toggle="tooltip" data-bs-placement="top" title="Undo review"><i
                                    class="fa fa fa-undo"></i></button>
                            @endif
                        </div>
                        @endforeach
                    </div>
