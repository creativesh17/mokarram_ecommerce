...
class SeoController extends Controller
{
    ...
    public function ctegories_set_save(Category $category)
    {
        ...
        $category->fill(request()->except('tags'));
        $category->save();

        $category->category_tag()->sync(request()->tags);
    ...
    public function products_set_save(Product $data)
    {
        ...
        $data->fill(request()->except("related_image",'tags'));
        $data->save();

        $data->product_tag()->sync(request()->tags);
    ...
    public function tags_store()
    {
        ...
        $tag->url = save_website_url($tag->url,'tags',$tag->id);
        $tag->save();
