    ...
    <div class="container custom-container">
        <div class="section_content">
            ...
            <div class="featured_items">
                @php
                $top_categories =
                    \App\Models\Category::where('is_top_category',1)->select(['id','url','name','is_top_category','category_image'])
                    ->where('status',1)
                    ->get();
                @endphp
                ...
                <div class="item">
                    <a href="{{url($item->url)}}" class=" product-category-item">
                        <div class="product-category-thumb">
                            <div class="">
                                <img src="{{env('PHOTO_URL')}}/{{ $item->category_image }}" alt="{{ $item->name }} Category">
                            </div>
                        </div>
