...
<!-- Mirrored from creativelayers.net/themes/techno-html/index-v6.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Dec 2023 10:14:40 GMT -->

<head>
    <!-- Basic Page Needs -->
    <meta charset="UTF-8">
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    <title>Techno Store - Home 6</title>
                    ...
                    <div class="row">
                        ...
                        <div class="grid-right">
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li class="column-1">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="shop-v2.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Shop
                                                        right sidebar</a>
                                                </li>
                                                <li>
                                                    <a href="shop-v3.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Shop list
                                                        view</a>
                                                </li>
                                                <li>
                                                    <a href="shop-v4.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Shop full
                                                        width</a>
                                                </li>
                                                <li>
                                                    <a href="shop-v5.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Shop 03
                                                        column</a>
                                                </li>
                                                <li>
                                                    <a href="shop-cart.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Shop
                                                        cart</a>
                                                </li>
                                                <li>
                                                    <a href="shop-checkout.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Shop
                                                        checkout</a>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="submenu">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-12">
                                                        ...
                                                        <ul class="submenu-child">
                                                            <li>
                                                                <a href="#" title="">Networking & Internet
                                                                    Devices</a>
                                                            </li>
                                                            <li>
                                                                <a href="#" title="">Laptops, Desktops &
                                                                    Monitors</a>
                                                            </li>
                                                            <li>
                                                                <a href="#" title="">Hard Drives & Memory
                                                                    Cards</a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        ...
                                                        <ul class="submenu-child">
                                                            ...
                                                            <li>
                                                                <a href="#" title="">Home Entertainment
                                                                    Systems</a>
                                                            </li>
                                                            <li>
                                                                <a href="#" title="">MP3 & Media
                                                                    Players</a>
                                                            </li>
                                                        </ul>
                                                        <div class="show">
                                                    ...
                                                    <div class="col-lg-2 col-md-12">
                                                        ...
                                                        <ul class="submenu-child">
                                                            <li>
                                                                <a href="#" title="">Home Theater
                                                                    Systems</a>
                                                            </li>
                                                            <li>
                                                                <a href="#" title="">Receivers &
                                                                    Amplifiers</a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="#" title="">CD Players &
                                                                    Turntables</a>
                                                            </li>
                                                            <li>
                                                                <a href="#" title="">High-Resolution
                                                                    Audio</a>
                                                            </li>
                                                            <li>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="banner-box">
                                                            <div class="inner-box">
                                                                <a href="#" title="">
                                                                    <img src="{{ asset('frontend') }}/images/banner_boxes/submenu-01.png"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="banner-box">
                                                            <div class="inner-box">
                                                                <a href="#" title="">
                                                                    <img src="{{ asset('frontend') }}/images/banner_boxes/submenu-02.png"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                        </div>
                                        ...
                                        <li class="column-1">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="categories.html" title=""><i
                                                            class="fa fa-angle-right"
                                                            aria-hidden="true"></i>Categories 01</a>
                                                </li>
                                                <li>
                                                    <a href="categories-v2.html" title=""><i
                                                            class="fa fa-angle-right"
                                                            aria-hidden="true"></i>Categories 02</a>
                                                </li>
                                                <li>
                                                    <a href="element.html" title=""><i
                                                            class="fa fa-angle-right"
                                                ...
                                                <li>
                                                    <a href="order-tracking.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Order
                                                        Tracking</a>
                                                </li>
                                                <li>
                                                    <a href="term-condition.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Terms &
                                                        Conditions</a>
                                                </li>
                                                <li>
                                                    <a href="single-product.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Single
                                                        Product 01</a>
                                                </li>
                                                <li>
                                        ...
                                        <li class="column-1">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="blog-v2.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Blog
                                                        right sidebar</a>
                                                </li>
                                                <li>
                                                    <a href="blog-v3.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Blog
                                                        list</a>
                                                </li>
                                                <li>
                                                    <a href="blog-v4.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Blog 02
                                                        column</a>
                                                </li>
                                                <li>
                                                    <a href="blog-v5.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Blog full
                                                        width</a>
                                                </li>
                                                <li>
                                                    <a href="blog-single.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Blog
                                                        single</a>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="column-1">
                                            ...
                                            <ul class="submenu">
                                                <li>
                                                    <a href="contact.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Contact
                                                        01</a>
                                                </li>
                                                <li>
                                                    <a href="contact-v2.html" title=""><i
                                                            class="fa fa-angle-right" aria-hidden="true"></i>Contact
                                                        02</a>
                                                </li>
                                            </ul>
                            ...
                            <ul class="flat-unstyled style1">
                                ...
                                <li>
                                    <a href="#" title="">USD<i class="fa fa-angle-down"
                                            aria-hidden="true"></i></a>
                                    <ul class="unstyled">
                                        <li>
                                            <a href="#" title="">Euro</a>
                                ...
                                <li>
                                    <a href="#" title="">English<i class="fa fa-angle-down"
                                            aria-hidden="true"></i></a>
                                    <ul class="unstyled">
                                        <li>
                                ...
                                <ul class="menu">
                                    <li>
                                        <a href="#" title="" class="dropdown">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/01.png"
                                                    alt="">
                                            </span>
                                            ...
                                            <div class="one-third">
                                                <ul class="banner">
                                                        ...
                                                        <div class="banner-text">
                                                            ...
                                                            <div class="more-link">
                                                                <a href="#" title="">Shop Now <img
                                                                        src="{{ asset('frontend') }}/images/icons/right-2.png"
                                                                        alt=""></a>
                                                            </div>
                                                        </div>
                                                        <div class="banner-img">
                                                            <img src="{{ asset('frontend') }}/images/banner_boxes/menu-01.png"
                                                                alt="">
                                                        </div>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="banner-img">
                                                            <img src="{{ asset('frontend') }}/images/banner_boxes/menu-02.png"
                                                                alt="">
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div class="banner-img">
                                                            <img src="{{ asset('frontend') }}/images/banner_boxes/menu-03.png"
                                                                alt="">
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </li>
                                    ...
                                    <li>
                                        <a href="#" title="" class="dropdown">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/02.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Mobile & Tablet
                                    ...
                                    <li>
                                        <a href="#" title="" class="dropdown">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/03.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Home Devices
                                    ...
                                    <li>
                                        <a href="#" title="">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/04.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Software
                                    ...
                                    <li>
                                        <a href="#" title="">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/05.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                TV & Audio
                                    ...
                                    <li>
                                        <a href="#" title="">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/06.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Sports & Fitness
                                    ...
                                    <li>
                                        <a href="#" title="" class="dropdown">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/07.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Games & Toys
                                    ...
                                    <li>
                                        <a href="#" title="">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/08.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Video Cameras
                                    ...
                                    <li>
                                        <a href="#" title="" class="dropdown">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/09.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Accessories
                                    ...
                                    <li>
                                        <a href="#" title="" class="dropdown">
                                            <span class="menu-img">
                                                <img src="{{ asset('frontend') }}/images/icons/menu/10.png"
                                                    alt="">
                                            </span>
                                            <span class="menu-title">
                                                Security
                                    ...
                                    <div class="box-search">
                                        ...
                                        <span class="btn-search">
                                            <button type="submit"><img
                                                    src="{{ asset('frontend') }}/images/icons/search-2.png"
                                                    alt=""></button>
                                        </span>
                                        <div class="search-suggestions">
                                            <div class="box-suggestions">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="image">
                                                            <img src="{{ asset('frontend') }}/images/product/other/s05.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="name">
                                                                <a href="#" title="">Razer
                                                                    RZ02-01071500-R3M1</a>
                                                            </div>
                                                            <div class="price">
                                                                <span class="sale">
                                                                    $50.00
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                            <img src="{{ asset('frontend') }}/images/product/other/s06.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="name">
                                                                <a href="#" title="">Notebook Black Spire
                                                                    V Nitro VN7-591G</a>
                                                            </div>
                                                            <div class="price">
                                                                <span class="sale">
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                            <img src="{{ asset('frontend') }}/images/product/other/14.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="name">
                                                                <a href="#" title="">Apple iPad Mini
                                                                    G2356</a>
                                                            </div>
                                                            <div class="price">
                                                                <span class="sale">
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                            <img src="{{ asset('frontend') }}/images/product/other/02.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="name">
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                            <img src="{{ asset('frontend') }}/images/product/other/l01.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="name">
                                                    ...
                                                    <li>
                                                        <div class="image">
                                                            <img src="{{ asset('frontend') }}/images/product/other/s08.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="info-product">
                                                            <div class="name">
                                                                <a href="#" title="">Beats Snarkitecture
                                                                    Headphones</a>
                                                            </div>
                                                            <div class="price">
                                                                <span class="sale">
                            ...
                            <div class="box-cart style1">
                                <div class="inner-box">
                                    <ul class="menu-compare-wishlist">
                                        <li class="compare">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/icons/compare-2.png"
                                                    alt="">
                                            </a>
                                        </li>
                                        <li class="wishlist">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/icons/wishlist-2.png"
                                                    alt="">
                                            </a>
                                        </li>
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="dropdown-box">
                                        <ul>
                                            <li>
                                                <div class="img-product">
                                                    <img src="{{ asset('frontend') }}/images/product/other/img-cart-1.jpg"
                                                        alt="">
                                                </div>
                                                <div class="info-product">
                                                    <div class="name">
                                            ...
                                            <li>
                                                <div class="img-product">
                                                    <img src="{{ asset('frontend') }}/images/product/other/img-cart-2.jpg"
                                                        alt="">
                                                </div>
                                                <div class="info-product">
                                                    <div class="name">
                                        ...
                                        <div class="btn-cart">
                                            <a href="shop-cart.html" class="view-cart" title="">View
                                                Cart</a>
                                            <a href="shop-checkout.html" class="check-out"
                                                title="">Checkout</a>
                                        </div>
                                    </div>
                                </div><!-- /.inner-box -->
                        ...
                        <div class="widget widget-apps">
                            ...
                            <ul class="app-list">
                                <li class="app-store">
                                    <a href="#" title="">
                                        <div class="img">
                                            <img src="{{ asset('frontend') }}/images/icons/app-store.png"
                                                alt="">
                                        </div>
                                        <div class="text">
                                            <h4>App Store</h4>
                                ...
                                <li class="google-play">
                                    <a href="#" title="">
                                        <div class="img">
                                            <img src="{{ asset('frontend') }}/images/icons/google-play.png"
                                                alt="">
                                        </div>
                                        <div class="text">
                                            <h4>Google Play</h4>
...
<!-- Mirrored from creativelayers.net/themes/techno-html/index-v6.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Dec 2023 10:14:43 GMT -->
