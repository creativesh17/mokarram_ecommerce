    ...
    <div @mouseover="mouseover" @mouseleave="mouseleave">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <left-nav-list-group :role_permissions="['super_admin','admin']" :icon="`fa fa-box`" :text="`Product`" :alert_count="0">
                ...
                <left-nav-list-item :to="'Offer'" :text="'Set Offer'" />
                <left-nav-list-item :to="'AllProductReview'" :text="'Reviews'" />
                <left-nav-list-item :to="'AllProductQuestion'" :text="'Questions'" />
            </left-nav-list-group>
            ...
            <left-nav-list-group :role_permissions="['super_admin','admin']" :icon="`fa fa-list`" :text="`Gallery`" :alert_count="0">
                <left-nav-list-item :to="'CreateGallery'" :text="'Create Gallery'" />
                <left-nav-list-item :to="'AllGallery'" :text="'Gallery List'" />
            </left-nav-list-group>
