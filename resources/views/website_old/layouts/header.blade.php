        ...
        <div class="header_area_content container">
            ...
            <div class="search_area">
                ...
                <form class="w-100" onsubmit="event.preventDefault();">
                    <input class="form-control shape_box3" onkeyup="on_keyup_search()" type="text" id="search" placeholder="Search Products" />
                    <button type="submit" class="search_icon" name="search">
            ...
            <div class="item_area">
                ...
                <div class="item account">
                    <span href="#">
                        <div class="icon">
                            <img src="{{ asset('contents/website/images/icons/icon_call.png') }}" alt="chattorgram computer call">
                        </div>
                        <div class="title_and_discription">
                            <div class="title">
                                <h2>
                            ...
                            <div class="discription">
                                @php
                                    ...
                                    $setting_first = collect($setting)->filter(function($i, $key) use($numbers){
