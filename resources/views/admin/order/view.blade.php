    ...
    <div class="row">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="order-primary-detail mb-4">
                                <h6>Order Placed</h6>
                                <p class="mb-0">{{ date_format($order->created_at, 'd M, Y | h:i A') }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="order-primary-detail mb-4">
                                <h6>Name</h6>
                                <p class="mb-0">{{ $order->shipping->ship_name }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="order-primary-detail mb-4">
                                <h6>Email ID</h6>
                                <p class="mb-0">{{ $order->shipping->ship_email }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="order-primary-detail mb-4">
                                <h6>Contact No</h6>
                                <p class="mb-0">{{ $order->shipping->ship_phone }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 ">
                            <div class="order-primary-detail mb-4">
                                ...
                                <p>{{ $order->shipping->ship_address }}
                                    <br/> {{ $order->shipping->ship_city }}
                                    <br/> {{ $order->shipping->ship_country }}</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 ">
                            <div class="order-primary-detail mb-4">
                        ...
                        <table class="table table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">1</th>
                                    <td>
                                        <img src="{{asset('contents/admin')}}/assets/images/ecommerce/product_01.svg" class="img-fluid" width="35" alt="product">
                                    </td>
                                    <td>{{ $product->product_name }}</td>
                                    <td>{{ $product->product_qty }}</td>
                                    <td>{{ $product->product_price }}</td>
                                    <td>{{ $product->product_discount }}%</td>
                                    <td class="text-right">{{ ($product->product_price * $product->product_qty) - ($product->product_price/100) * $product->product_discount}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
                    ...
                    <div class="row border-top pt-3">
                        <div class="col-md-12 order-2 order-lg-1 col-lg-4 col-xl-6">
                            <div class="order-note">
                                <p class="mb-5"><span class="badge badge-secondary-inverse">Shipping Charge Applied</span></p>
                                <h6>Note :</h6>
        ...
        <div class="col-lg-5 col-xl-4">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/order/delivered/email/'.$order->id) }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <select name="status" id="orderCategory" class="form-control">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" name="message" id="specialMessage" rows="3" placeholder="Add Special Message"></textarea>
                        </div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <p>
                        <button type="button" class="btn btn-primary-rgba my-1"><i class="feather icon-file mr-2"></i>Invoice</button>
                    </p>
                    <p>
                        <button type="button" class="btn btn-info-rgba my-1"><i class="feather icon-box mr-2"></i>Packaing Slip</button>
                    </p>
                    <p>
                        <button type="button" class="btn btn-success-rgba my-1"><i class="feather icon-gift mr-2"></i>Gift Wrap Detail</button>
                    </p>
                </div>
            </div>
        </div>
