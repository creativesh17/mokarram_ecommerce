...
<div class="contentbar">
    <!-- Start row -->
    <form action="{{ url('admin/products/'.$product->product_slug) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <div class="row">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        <div class="form-group row {{$errors->has('product_name') ? ' has-error':''}}">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control font-20" name="product_name" value="{{ $product->product_name }}" >
                                @error('product_name')
                        ...
                        <div class="form-group row {{$errors->has('product_feature') ? ' has-error':''}}">
                            ...
                            <div class="col-sm-12">
                            <textarea name="product_feature" class="summernote">{{ $product->product_feature }}</textarea>
                            </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-0 {{$errors->has('product_discount') ? ' has-error':''}}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="product_discount" id="product_discount" value="{{ $product->product_discount }}">
                                ...
                                <div class="form-group row mb-0 mt-2 {{$errors->has('product_stock') ? ' has-error':''}}">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="product_stock" id="product_stock" value="{{ $product->product_stock }}">
                                        @error('product_stock')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="form-group row mb-0 {{$errors->has('product_description') ? ' has-error':''}}">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea name="product_description" class="form-control" id="product_description" cols="30" rows="6">{{ $product->product_description }}</textarea>
            ...
            <div class="col-lg-4 col-xl-3">
                    ...
                    <div class="card-body">
                        <select class="select2-multi-select form-control" name="subcategories[]" id="subcategories"  multiple>
                            ...
                            @foreach ($subcategories as $subcategory)
                                ...
                                @foreach ($product->subcategories as $productSubcategories)
                                {{$productSubcategories->id == $subcategory->id ? 'selected':'' }}
                                @endforeach  
                                >{{ $subcategory->subcate_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="card m-b-30">
                    ...
                    <div class="form-group {{$errors->has('new_from') ? ' has-error':''}}">
                        ...
                        <input type="text" name="new_from" id="default-date-from" class="datepicker-here form-control" placeholder="New From Date" value="{{ $product->new_from }}"/>
                        @error('new_from')
                            <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group {{$errors->has('new_to') ? ' has-error':''}}">
                        ...
                        <input type="text" name="new_to" id="default-date-to" class="datepicker-here form-control" placeholder="New To Date" value="{{ $product->new_to }}"/>
                        @error('new_to')
                            <span class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </span>
