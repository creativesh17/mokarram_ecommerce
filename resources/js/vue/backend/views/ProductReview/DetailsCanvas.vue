                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <img :src="this[`get_${store_prefix}`].product.photo_url" style="height: 100px;" alt="">
                            </td>
                        </tr>
                        <tr>
                            <td>Product</td>
                            <td>:</td>
                            <td>{{ this[`get_${store_prefix}`].product?.product_name }}</td>
                        </tr>
                        <tr>
                            <td>User Name</td>
                            <td>:</td>
                            <td>{{ this[`get_${store_prefix}`].user?.first_name }}</td>
                        </tr>
                        <tr>
                            <td>Star</td>
                            <td>:</td>
                            <td>{{ this[`get_${store_prefix}`].star }}</td>
                        </tr>
                        <tr>
                            <td>Review</td>
                            <td>:</td>
                            <td>{{ this[`get_${store_prefix}`].review_description }}</td>
                        </tr>
