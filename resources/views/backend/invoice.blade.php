                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="right">{{ $order->product_price }} tk</td>
                                        <td class="center">{{ $order->qty }}</td>
                                        <td class="right" style="text-align: right;">{{ $order->product_price * $order->qty }} tk</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                                ...
                                <table class="table table-clear" style="white-space: nowrap;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="right" style="text-align: right;">{{ $order_details->sub_total }} tk</td>
                                        </tr>
                                        <tr>
                                            <td class="left">
                                                <strong class="text-dark">Delivery Charge</strong>
                                            </td>
                                            <td class="right" style="text-align: right;">{{ $order_details->total_price  - $order_details->sub_total }} tk</td>
                                        </tr>
                                        <tr>
                                            <td class="left">
                                            ...
                                            <td class="right" style="text-align: right;">
                                                <strong class="text-dark">{{ $order_details->total_price }} tk</strong>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
