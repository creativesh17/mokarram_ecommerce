    ...
    <div class="container custom-container">
        <div class="banner">
            <div class="left">
                ...
                <div class="bottom">
                    <div class="two">
                        <img  src="/{{$setting->side_banner_left_top}}" class="img-fluid" alt="banner">
                    </div>
                    <div class="three">
                        <img src="/{{$setting->side_banner_right_top}}" class="img-fluid" alt="banner">
                    </div>
                    <div class="four">
                        <img src="/{{$setting->side_banner_left_bottom}}" class="img-fluid" alt="banner">
                    </div>
                    <div class="five">
                        <img src="/{{$setting->side_banner_right_bottom}}" class="img-fluid" alt="banner">
                    </div>
                </div>
            </div>
            <div class="right">
