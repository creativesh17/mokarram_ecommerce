                        ...
                        <div class="col-lg-10">
                            <div class="admin_form form_1">
                                ...
                                <div class=" form-group full_width d-grid align-content-start gap-1 mb-2 " >
                                    ...
                                    <textarea name="description" :value="data.description" class="form-control" rows="10" style="resize: both;"></textarea>
                                </div>
...
export default {
    ...
    created: function () {
        this[`fetch_${store_prefix}`]({id: this.$route.params.id},{render: true});
    },
    methods: {
        ...mapActions([
