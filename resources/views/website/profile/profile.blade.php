                    ...
                    <div class="col-lg-9 col-md-8 ">
                        <div class="card">
                            <div class="card-body" style="padding: 20px;">
                                ...
                                <form class="account-details-form account-box-padding-4 mt-4" action="{{ url('/profile/update') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="single-input-item">
                                        ...
                                        {{-- <button class="btn btn-info check-btn sqr-btn" >Save Changes</button> --}}
                                    </div>
                                </form>
                            </div>
                        </div>
