                    ...
                    <div class="product-box">	
                        <div class="imagebox">
                             <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/05.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                             <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/02.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                             <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/06.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                             <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/03.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                    ...
                    <div class="product-box">
                        <div class="imagebox">
                             <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/07.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
                        ...
                        <div class="imagebox">
                            <span class="item-sale">SALE</span>
                             <ul class="box-image owl-carousel-1">
                                <li>
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/04.jpg" alt="">
                                    </a>
                                </li>
                                <li>
                                    <a href="#" title="">
        ...
        <div class="row">
            <div class="col-md-12 owl-carousel-10">
                ...
                @foreach($topCate as $cate)
                    <a href="{{ url('/get-category-product/'.$cate->id) }}">
                ...
                {{-- <div class="owl-carousel-item">
                    <div class="product-box style1">
                        <div class="imagebox style1">
                            ...
                            <div class="box-image">
                                <a href="#" title="">
                                    <img src="{{ asset('frontend') }}/images/product/other/s02.jpg" alt="">
                                </a>
                            </div><!-- /.box-image -->
                            ...
                            <div class="col-md-6">
                                <div class="product-box">
                                    <div class="imagebox style2 v1">
                                        <div class="box-image">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/product/other/l01.jpg" alt="">
                                            </a>
                                        </div><!-- /.box-image -->
                                        <div class="box-content">
                                            <div class="cat-name">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="product-box style2">
                                    <div class="imagebox style2">
                                        <div class="box-image">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/product/other/l02.jpg" alt="">
                                            </a>
                                        </div><!-- /.box-image -->
                                        <div class="box-content">
                                            <div class="cat-name">
                                ...
                                <div class="product-box style2">
                                    <div class="imagebox style2">
                                        <div class="box-image">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/product/other/l04.jpg" alt="">
                                            </a>
                                        </div><!-- /.box-image -->
                                        <div class="box-content">
                                            <div class="cat-name">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="product-box style2">
                                    <div class="imagebox style2">
                                        <div class="box-image">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/product/other/l03.jpg" alt="">
                                            </a>
                                        </div><!-- /.box-image -->
                                        <div class="box-content">
                                            <div class="cat-name">
                                ...
                                <div class="product-box style2">
                                    <div class="imagebox style2">
                                        <div class="box-image">
                                            <a href="#" title="">
                                                <img src="{{ asset('frontend') }}/images/product/other/l05.jpg" alt="">
                                            </a>
                                        </div><!-- /.box-image -->
                                        <div class="box-content">
                                            <div class="cat-name">
                        ...
                        <div class="product-item">
                            <div class="imagebox style3">
                                <div class="box-image save">
                                    <a href="#" title="">
                                        <img src="{{ asset('frontend') }}/images/product/other/l06.jpg" alt="">
                                    </a>
