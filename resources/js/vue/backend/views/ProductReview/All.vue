                ...
                <table class="table table-hover table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'product_id'" :title="'product'" />
                            <table-th :sort="true" :tkey="'user_id'" :title="'user'" />
                            <table-th :sort="true" :tkey="'star'" :title="'star'" />
                            <!-- <table-th :sort="true" :tkey="'review_description'" :title="'review'" /> -->
                            <table-th :sort="true" :tkey="'approve'" :title="'approve'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <input @click="approve(item.id)" type="checkbox" v-if="item.approve" checked class="form-check-input">
                                <input @click="approve(item.id)" type="checkbox" v-else class="form-check-input">
                            </td>
                            <td>
...
export default {
    ...
    methods: {
        ...
        ...mapActions({
            'approve' : `fetch_${store_prefix}_approve`,
        }),
        ...mapMutations([
